...
# Architope(s)
Path('./outputs/models/Architopes/OLS_tope/').mkdir(parents=True, exist_ok=True)
Path('./outputs/models/Architopes/LASSO_tope/').mkdir(parents=True, exist_ok=True)
Path('./outputs/models/Architopes/Gradient_Boosted_Tree_tope/').mkdir(parents=True, exist_ok=True)
# LaTeX and misc. output(s)
Path('./outputs/plots/').mkdir(parents=True, exist_ok=True)
Path('./outputs/tables/').mkdir(parents=True, exist_ok=True)
Path('./outputs/tables/Architopes/OLS_tope').mkdir(parents=True, exist_ok=True)
